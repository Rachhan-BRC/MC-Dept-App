...
{
    internal class SQLConnectAllSection
    {
        ...
        public void Connection()
        {
            ...
            try
            {
                ...
                //now to read file:
                string FilePath = CDirectory + @"\SystemSettingAllSection.ini";
            ...
            con = new SqlConnection("Data Source=tcp:" + server + ";Initial Catalog=" + db + ";User ID= " + username + ";Password=" + password + ";");
        }
    }
}
