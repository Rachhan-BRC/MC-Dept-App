...
{
    public partial class EditCustomerClaim : Form
    {
        SQLConnect cnn = new SQLConnect();
        private readonly string _category;
        private readonly string _type;
        private readonly DateTime _monthYear;
        public EditCustomerClaim(string category, string type, DateTime monthYear)
        {
            InitializeComponent();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "Update  tbCustomerClaim Set Qty = @Qty, UpdateBy = @UpdateBy, UpdateDate = @UpdateDate " +
