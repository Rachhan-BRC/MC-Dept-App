...
{
    public partial class InsertDefectOutFlow : Form
    {
        SQLConnect cnn = new SQLConnect();
        private readonly string _category;
        private readonly string _type;
        private readonly DateTime _monthYear;
        public InsertDefectOutFlow(string category, string type, DateTime monthYear)
        {
            InitializeComponent();
            cnn.Connection();
            _category = category;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "INSERT INTO tbDefectOutFlow (Category, Type, MonthYear, Qty, Status, RegBy, RegDate, UpdateBy, UpdateDate) " +
