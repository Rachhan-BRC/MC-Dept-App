...
{
    public partial class AddCustomerClaimForm : Form
    {
        SQLConnect cnn = new SQLConnect();
        private readonly string _category;
        private readonly string _type;
        private readonly DateTime _monthYear;
        public AddCustomerClaimForm(string category, string type, DateTime monthYear)
        {
            InitializeComponent();
            cnn.Connection();
            _category = category;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "INSERT INTO tbCustomerClaim (Category, Type, MonthYear, Qty, Status, RegBy, RegDate, UpdateBy, UpdateDate) " +
                    "VALUES (@Category, @Type, @MonthYear, @Qty, 1, @RegisterBy, @RegisterDate, @UpdateBy, @UpdateDate)", cnn.con);
