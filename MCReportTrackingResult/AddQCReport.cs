...
{
    public partial class AddQCReport : Form
    {
        ...
        public AddQCReport( string category, string type, DateTime monthYear)
        {
            InitializeComponent();
           cnn.Connection();
            _category = category;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "INSERT INTO tbQCReport (Category, Type, MonthYear, Qty, Status, RegBy, RegDate, UpdateBy, UpdateDate) " +
