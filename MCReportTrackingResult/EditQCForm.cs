...
{
    public partial class EditQCForm : Form
    {
        SQLConnect cnn = new SQLConnect();
        private readonly string _category;
        private readonly string _type;
        private readonly DateTime _monthYear;
        public EditQCForm(string category, string type, DateTime monthYear)
        {
            InitializeComponent();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "Update tbQCReport Set Qty = @Qty, UpdateBy = @UpdateBy, UpdateDate = @UpdateDate " +
