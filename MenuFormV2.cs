...
namespace MachineDeptApp
{
    public partial class MenuFormV2 : Form
    {
        ...
        private void TreeViewMenu_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        {
            ...
            if (currentClkNode.Text == "Master Label Semi Print")
            {
                //Check if already open >> Focus on that Form
                int FoundOpened = 0;
                for (int i = 0; i < dtOpenForm.Rows.Count; i++)
                ...
                if (FoundOpened == 0)
                {
                    MasterLabelSemiPrint Spsf = new MasterLabelSemiPrint();
                    Spsf.MdiParent = MenuFormV2.ActiveForm;
                    Spsf.Show();
                    tabControlOpenForm.TabPages.Add("Master Label Semi Print");
                    dtOpenForm.Rows.Add("MasterLabelSemiPrint", "Master Label Semi Print");
                }
            ...
            if (currentClkNode.Text == "Master List")
            {
                //Check if already open >> Focus on that Form
                int FoundOpened = 0;
                for (int i = 0; i < dtOpenForm.Rows.Count; i++)
                ...
                if (FoundOpened == 0)
                {
                    RegisterMasterNGType Nif = new RegisterMasterNGType();
                    Nif.MdiParent = MenuFormV2.ActiveForm;
                    Nif.Show();
           ...
           if (currentClkNode.Text == "Receive Invoice")
           {
               //Check if already open >> Focus on that Form
               int FoundOpened = 0;
               for (int i = 0; i < dtOpenForm.Rows.Count; i++)
               ...
               if (FoundOpened == 0)
               {
                   ...
                   Uf.MdiParent = MenuFormV2.ActiveForm;
                   Uf.Show();
                   tabControlOpenForm.TabPages.Add("Receive Invoice");
                   dtOpenForm.Rows.Add("InvoiceForm", "Receive Invoice");
               }
           ...
           if (currentClkNode.Text == "Stock Return (In/Out)")
           {
               //Check if already open >> Focus on that Form
               int FoundOpened = 0;
               for (int i = 0; i < dtOpenForm.Rows.Count; i++)
               ...
               if (FoundOpened == 0)
               {
                   ...
                   Uf.MdiParent = MenuFormV2.ActiveForm;
                   Uf.Show();
                   tabControlOpenForm.TabPages.Add("Stock Return (In/Out)");
                   dtOpenForm.Rows.Add("StockINOut", "Stock Return (In/Out)");
               }
           }
           ...
           if (currentClkNode.Text == "Request Form")
           {
            ...
            if (currentClkNode.Text == "អ្នកទទួលបន្ទុករាប់ស្តុក SD")
            {
                //Check if already open >> Focus on that Form
                int FoundOpened = 0;
                for (int i = 0; i < dtOpenForm.Rows.Count; i++)
                ...
                if (FoundOpened == 0)
                {
                    SDMstPic Uf = new SDMstPic();
                    Uf.MdiParent = MenuFormV2.ActiveForm;
                    Uf.Show();
                    tabControlOpenForm.TabPages.Add("អ្នកទទួលបន្ទុករាប់ស្តុក SD");
                    dtOpenForm.Rows.Add("SDMstPic", "អ្នកទទួលបន្ទុករាប់ស្តុក SD");
                }

            }
            if (currentClkNode.Text == "NG Calculate")
            {
                //Check if already open >> Focus on that Form
                int FoundOpened = 0;
                for (int i = 0; i < dtOpenForm.Rows.Count; i++)
                ...
                if (FoundOpened == 0)
                {
                    NGCalculateForm Uf = new NGCalculateForm();
                    Uf.MdiParent = MenuFormV2.ActiveForm;
                    Uf.Show();
                    tabControlOpenForm.TabPages.Add("NG Calculate");
                    dtOpenForm.Rows.Add("NGCalculateForm", "NG Calculate");
                }
        ...
        private void MenuFormV2_Load(object sender, EventArgs e)
        {
            ...
            dtChildRoot.Rows.Add(2, "Master Label Semi Print", "MasterLabelSemiPrint");
            ...
            dtChildRoot.Rows.Add(3, "NG Calculate", "NGCalculateForm");
            ...
            dtChildRoot.Rows.Add(8, "Stock Return (In/Out)", "StockINOut");
            dtChildRoot.Rows.Add(8, "Receive Invoice", "InvoiceForm");
