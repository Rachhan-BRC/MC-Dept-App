...
{
    public partial class KITStockINForm : Form
    {
        SqlCommand cmd;
        ...
        public KITStockINForm()
        {
            InitializeComponent(); 
            this.cnn.Connection();
            this.cnnOBS.Connection();
            this.Load += KITStockINForm_Load;
        ...
        {
            KITStockINFormAdd Ksifa = new KITStockINFormAdd(this);
            Ksifa.ShowDialog();
        }
        ...
        private void KITStockINForm_Load(object sender, EventArgs e)
        {
