...
{
    public partial class SemiPress2SearchForm : Form
    {
        ...
        private void SemiPress2SearchForm_Load(object sender, EventArgs e)
        {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (DLR == DialogResult.Yes)
                {
                    ...
                    {
                        cnn.con.Open();
                        string query = "UPDATE tbSemiPress2 SET " +
                                            "DeleteState='1'," +
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                cnn.con.Open();
                SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM tbSemiPress2 " + SQLConds + "ORDER BY RegDate ASC​;", cnn.con);
